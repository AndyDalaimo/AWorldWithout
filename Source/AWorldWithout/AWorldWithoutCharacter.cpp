...
AAWorldWithoutCharacter::AAWorldWithoutCharacter()
{
...
void AAWorldWithoutCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AAWorldWithoutCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AAWorldWithoutCharacter::Move);
...
void AAWorldWithoutCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
